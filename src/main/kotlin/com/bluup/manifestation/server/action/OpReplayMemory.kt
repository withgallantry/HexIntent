...
/**
 * Replays a stored memory list by memory id from the held Memory Crystal.
 */
object OpReplayMemory : ConstMediaAction {
    ...
    override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
        ...
        val stored = MemoryCrystalData.readPatterns(carrier.stack, env.world)
            ?: throw MishapMemoryIdNotOnCrystal()

        if (!stored.list.nonEmpty) {
