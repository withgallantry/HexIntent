...
public final class PresenceIntentIota extends Iota {
    ...
    public @NotNull Tag serialize() {
        ...
        NBTHelper.put(out, "position", HexUtils.serializeToNBT(position));
        NBTHelper.put(out, "facing", HexUtils.serializeToNBT(facing));
        NBTHelper.putString(out, "dimension", dimensionId);
        return out;
    }
